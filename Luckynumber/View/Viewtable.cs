...
namespace arconfirmationletter.View
{
    ...
    public partial class Viewtable : Form
    {
        ...
        public void Reloadletterreturn(String inutstring)

        {
            ...
            if (this.dataGridView1.CurrentRow != null)
            {
                ...
                DateTime fromdate = (DateTime)dataGridView1.Rows[this.dataGridView1.CurrentRow.Index].Cells["fromdate"].Value;
                DateTime todate = (DateTime)dataGridView1.Rows[this.dataGridView1.CurrentRow.Index].Cells["todate"].Value;

                var rsthisperiod = from tbl_Preriod in dc.tbl_Preriods
                                   where tbl_Preriod.fromdate >= fromdate && tbl_Preriod.todate <= todate
                                   && ((int)tbl_Preriod.customercodeGR).ToString().Contains(inutstring)
                                   select tbl_Preriod;
                ...
                if (rsthisperiod.Count() > 0)
                {
                    ...
                    //sourceData.Columns["Sold-to"].DataType = typeof(float);
...

        {
            ...
            System.Data.DataTable dt = new System.Data.DataTable();
            LinqtoSQLDataContext dc = new LinqtoSQLDataContext(connection_string);
            var rsthisperiod = from tblCustomer in dc.tblCustomers
        ...
        public void ReloadtblFBL5Nnewthisperiod(string text)
        {
            #region // show all
            System.Data.DataTable dt = new System.Data.DataTable();
            ...
            var rsthisperiod = from tblFBL5Nnewthisperiod in db.tblFBL5Nnewthisperiods
                               where ((int)tblFBL5Nnewthisperiod.Account).ToString().Contains(text)
            ...
            this.dataGridView1.Columns["Customer_Name"].DefaultCellStyle.Format = "N0";
            ...
            //this.dataGridView1.Columns["myFirstCol"].DisplayIndex = 14;
            //this.dataGridView1.Columns["myFirstCol"].DisplayIndex = 15;
            //this.dataGridView1.Columns["myFirstCol"].DisplayIndex = 16;
            //this.dataGridView1.Columns["myFirstCol"].DisplayIndex = 17;
            //this.dataGridView1.Columns["myFirstCol"].DisplayIndex = 18;
            //this.dataGridView1.Columns["myFirstCol"].DisplayIndex = 19;
            //this.dataGridView1.Columns["myFirstCol"].DisplayIndex = 20;
        ...
        public void Reloadcustomerbeginbalance(string text)
        {
            ...
            var rsthisperiod = from tblFBL5beginbalace in dc.tblFBL5beginbalaces
                               where ((int)tblFBL5beginbalace.Account).ToString().Contains(text)
        ...
        public Viewtable(IQueryable rs, LinqtoSQLDataContext db, string fornname, int viewcode, DateTime fromdate, DateTime todate)
        {
            ...
            if (parts.Count() >= 4)
            {
                // this.lb_seach.Text = "F5 CHI TIẾT/ F12 TÍNH TỔNG";
                this.Pl_endview.Visible = true;
                this.lb_seach.Visible = true;
                this.Dtgridview = dataGridView1;
                //   string line1 = this.Text;
                ...
                //        this.Text = "VIEWLIST DATABASE UPLOADED ON SYSYEM FROM-" + fromdate.Day + "/" + fromdate.Month + "/" + fromdate.Year + " -TO- " + todate.Day + "/" + todate.Month + "/" + todate.Year + " SUM REPORTS";
            ...
            if (fornname == "iNPUT DEPOSIT AMOUNTT !")
            {
                ...
                getData(dataCollectionaccount);

                this.dataCollectionaccount = dataCollectionaccount;

                List<ComboboxItem> dataCollectiongroup = new List<ComboboxItem>();
                getDatagr(dataCollectiongroup);
            ...
            if (fornname == "LIST BEGIN BALANCE !")
            {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (this.Text == "Update Customer make reports !" || this.Text == "LIST CUSTOMER MAKE REPORTS")
            {
                ...
                #region  // doan update vào data
                db.CommandTimeout = 0;

                var rs = from tblCustomer in db.tblCustomers
                         where tblCustomer.id == int.Parse(dataGridView1.Rows[this.dataGridView1.CurrentRow.Index].Cells["id"].Value.ToString())
                ...
                if (rs.Count() > 0)
                {
                    foreach (var item in rs)
                    {
                        ...
                        {
                            item.Reportsend = !(bool)dataGridView1.Rows[this.dataGridView1.CurrentRow.Index].Cells["Reportsend"].Value;
                        }
                        else
                        {
                        ...
                        //    dataGridView1.CurrentRow.ReadOnly = false;//= !(bool)dataGridView1.Rows[this.dataGridView1.CurrentRow.Index].Cells["Reportsend"].Value; ;
                    ...
                    if (kq)
                    {
                        ...
                        if (Utils.IsValidnumber(newvalue))
                        {
                            ...
                            catch (Exception)
                            {
                                ...
                                MessageBox.Show("Bạn đang ở bảng tổng hợp, nếu muốn thay đổi dữ liệu bạn phải double click vào code khách hàng để view chi tiết trước !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                        ...
                        else
                        {
                            ...
                            MessageBox.Show("Please input a number !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                    }
                    #endregion
